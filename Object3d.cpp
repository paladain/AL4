...
bool Object3d::LoadTexture(const std::string& directoryPath, const std::string& filename)
{
	...
	CD3DX12_HEAP_PROPERTIES A1(D3D12_CPU_PAGE_PROPERTY_WRITE_BACK, D3D12_MEMORY_POOL_L0);
...
bool Object3d::Initialize()
{
	...
	CD3DX12_HEAP_PROPERTIES A1(D3D12_HEAP_TYPE_UPLOAD);
	CD3DX12_RESOURCE_DESC A2(CD3DX12_RESOURCE_DESC::Buffer((sizeof(ConstBufferDataB0) + 0xff) & ~0xff));
	...
	CD3DX12_HEAP_PROPERTIES B1(D3D12_HEAP_TYPE_UPLOAD);
	CD3DX12_RESOURCE_DESC B2(CD3DX12_RESOURCE_DESC::Buffer((sizeof(ConstBufferDataB1) + 0xff) & ~0xff));
